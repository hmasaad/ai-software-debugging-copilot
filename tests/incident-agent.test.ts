  ...
  it("writes a SEV-style report from specialist findings", () => {
    const report = buildIncidentReport({
      ...
      reproduction: {
        ...
        symptoms: {
          summary: "TypeError at cart.js:16",
          errorType: "TypeError",
        ...
        scenario: {
          ...
          setup: ["Start from crash site `src/cart.js:16`."],
          action: "Run `npm test --silent`.",
      ...
      causeAnalysis: {
        ...
        graph: {
          ...
          confidence: 0.8,
          nodes: [{ id: "crash", kind: "crash", label: "TypeError" }],
          supporting: [
            { id: "stack-trace", label: "Stack trace", present: true, supports: true, detail: "src/cart.js:16" },
          ],
          contradicting: [],
          summary: "Null/undefined dereference (80%) via TypeError.",
        },
